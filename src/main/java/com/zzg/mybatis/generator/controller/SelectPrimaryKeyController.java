 ...
 */
public class SelectPrimaryKeyController extends BaseFXController {
    ...
    @FXML
    private TableColumn<UITableColumnVO,String> columnRemark;
    @FXML
    private TableColumn<UITableColumnVO,String> columnIsPrimaryKey;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        columnRemark.setCellValueFactory(new PropertyValueFactory<>("columnRemark"));
        columnIsPrimaryKey.setCellValueFactory(new PropertyValueFactory<>("columnIsPrimaryKey"));
            ...
            this.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent event) {
                    if (event.getButton().equals(MouseButton.PRIMARY)
                            ...
                            && SelectPrimaryKeyController.TableRowControl.this.getIndex() < columnListView.getItems().size()) {
                        ok();
                    }
                }
            });
    ...
    public void ok(){
        ...
        if(null!=focusedItem){
            mainUIController.setGenerateKeysFieldText(focusedItem.getColumnName());
        }
